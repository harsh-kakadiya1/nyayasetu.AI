      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-card/30">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="space-y-2 animate-counter-up">
                <div className="text-3xl font-bold text-primary">500+</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.documentsAnalyzed')}</div>
              </div>
              <div className="space-y-2 animate-counter-up [animation-delay:200ms]">
                <div className="text-3xl font-bold text-primary">95%</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.accuracyRate')}</div>
              </div>
              <div className="space-y-2 animate-counter-up [animation-delay:400ms]">
                <div className="text-3xl font-bold text-primary">30s</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.averageAnalysis')}</div>
              </div>
              <div className="space-y-2 animate-counter-up [animation-delay:600ms]">
                <div className="text-3xl font-bold text-primary">24/7</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.available')}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-2xl p-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-foreground mb-2">See How It Works</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              <div className="group bg-card rounded-xl border border-border p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:animate-pulse-glow">
                    <CheckCircle className="w-6 h-6 text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-xl text-foreground mb-3">{t('home.features.instantSummaries.title')}</h3>
              ...
              <div className="group bg-card rounded-xl border border-border p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in [animation-delay:200ms]">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:animate-pulse-glow">
                    <Zap className="w-6 h-6 text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-xl text-foreground mb-3">{t('home.features.riskAnalysis.title')}</h3>
                    <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="group bg-card rounded-xl border border-border p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in [animation-delay:400ms]">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:animate-pulse-glow">
                    <FileText className="w-6 h-6 text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-xl text-foreground mb-3">{t('home.features.clauseBreakdown.title')}</h3>
                    <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="group bg-card rounded-xl border border-border p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in [animation-delay:600ms]">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 group-hover:animate-pulse-glow">
                    <Users className="w-6 h-6 text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-xl text-foreground mb-3">{t('home.features.accessible.title')}</h3>
                    <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
            <div className="bg-card border border-border rounded-xl p-8 max-w-lg w-full relative shadow-2xl animate-fade-in">
              ...
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-semibold text-foreground">{t('home.disclaimer.title')}</h3>
              </div>
